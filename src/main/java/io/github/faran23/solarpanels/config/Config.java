...
@EventBusSubscriber(modid = SolarPanels.MODID, bus = EventBusSubscriber.Bus.MOD)
public class Config {
...
//    }
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        tierMap.put(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_1_UPGRADE_ITEM.get())),
                new Tier(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_1_UPGRADE_ITEM.get())),
                        TIER_1_GEN_INCREASE.get(), TIER_1_TRANSFER_INCREASE.get(), TIER_1_CAPACITY_INCREASE.get(),
                        new Color(t1Color)
                )
        );
        int t2Color = TIER_2_COLOR.get();
        tierMap.put(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_2_UPGRADE_ITEM.get())),
                new Tier(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_2_UPGRADE_ITEM.get())),
                        TIER_2_GEN_INCREASE.get(), TIER_2_TRANSFER_INCREASE.get(), TIER_2_CAPACITY_INCREASE.get(),
                        new Color(t2Color)
                )
        );
        int t3Color = TIER_3_COLOR.get();
        tierMap.put(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_3_UPGRADE_ITEM.get())),
                new Tier(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_3_UPGRADE_ITEM.get())),
                        TIER_3_GEN_INCREASE.get(), TIER_3_TRANSFER_INCREASE.get(), TIER_3_CAPACITY_INCREASE.get(),
                        new Color(t3Color)
                )
        );
        int t4Color = TIER_4_COLOR.get();
        tierMap.put(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_4_UPGRADE_ITEM.get())),
                new Tier(BuiltInRegistries.ITEM.get(ResourceLocation.parse(TIER_4_UPGRADE_ITEM.get())),
