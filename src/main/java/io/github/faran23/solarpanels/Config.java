...
public class Config {
    ...
    private static final List<String> ALL_ITEMS = ForgeRegistries.ITEMS.getKeys().stream().map(ResourceLocation::toString).toList();
    ...
    public static final ForgeConfigSpec.EnumValue<GroupColor> DEFAULT_COLOR = BUILDER
    ...
    // initial values
    public static final ForgeConfigSpec.IntValue INITIAL_GENERATION_RATE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue INITIAL_CAPACITY = BUILDER
    ...
    // max values
    public static final ForgeConfigSpec.IntValue MAX_GENERATION_RATE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue MAX_CAPACITY = BUILDER
