...
public class Config {
    ...
    // initial values
    public static final ForgeConfigSpec.IntValue INITIAL_GENERATION__RATE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue INITIAL_TRANSFER_RATE = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue INITIAL_MAX_ENERGY = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends Integer>> TIER_1_COLOR = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends Integer>> TIER_2_COLOR = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends Integer>> TIER_3_COLOR = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends Integer>> TIER_4_COLOR = BUILDER
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        tierMap.put(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_1_UPGRADE_ITEM.get())),
                new Tier(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_1_UPGRADE_ITEM.get())),
        ...
        tierMap.put(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_2_UPGRADE_ITEM.get())),
                new Tier(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_2_UPGRADE_ITEM.get())),
        ...
        tierMap.put(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_3_UPGRADE_ITEM.get())),
                new Tier(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_3_UPGRADE_ITEM.get())),
        ...
        tierMap.put(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_4_UPGRADE_ITEM.get())),
                new Tier(ForgeRegistries.ITEMS.getValue(new ResourceLocation(TIER_4_UPGRADE_ITEM.get())),
